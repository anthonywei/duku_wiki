...
$upExt='txt,rar,zip,jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid,ppt,doc,pptx,docx,php,xls,xlsx';//上传扩展名
...
if($err==''){
	...
	if(preg_match('/^('.str_replace(',','|',$upExt).')$/i',$extension))
	{
		...
		else
		{
			...
			else $msg="{\"url\":\"{$_GET['prefix']}lib/xheditor-1.1.14/demos/".$targetPath."\",\"localname\":\"".jsonString($localName)."\",\"id\":\"1\"}";//id参数固定不变，仅供演示，实际项目中可以是数据库ID
		}
	}
